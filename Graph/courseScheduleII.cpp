...
/* Problem is to arrange courses in u->v format
For this purpose, we will check if cycle is present in directed graph or another approach is topological sort
